...
var CONDITIONAL_DOC_CONFIG = {
    ...
    adv_rel_birth_cert_orig:  { label: 'Student\'s Birth Certificate — Original', sectionId: 'docSection_relationship', spFolder: 'Annexture 17 - Relationship to Sponsor', multi: false },
    adv_rel_birth_cert_trans: { label: 'Student\'s Birth Certificate — Translation', sectionId: 'docSection_relationship', spFolder: 'Annexture 17 - Relationship to Sponsor', multi: false },
    adv_rel_marriage_cert_orig: { label: 'Student\'s Marriage Certificate — Original', sectionId: 'docSection_relationship', spFolder: 'Annexture 17 - Relationship to Sponsor', multi: false },
    ...
    adv_emp_payslips:       { label: 'Pay slips for each employment (Last 3 months)', sectionId: 'docSection_employment', spFolder: 'Annexture 14 - Current Work Experience', multi: true },
    ...
    adv_home_vehicle_book:    { label: 'Vehicle Registration Book', sectionId: 'docSection_homeTies', spFolder: 'Annexture 16 - Travel History', multi: true },
    adv_home_vehicle_valuation:{ label: 'Vehicle Valuation Report', sectionId: 'docSection_homeTies', spFolder: 'Annexture 16 - Travel History', multi: true },
    adv_home_travel_evidence: { label: 'Evidence of Previous International travels', sectionId: 'docSection_homeTies', spFolder: 'Annexture 16 - Travel History', multi: true },
    ...
    adv_home_business_tax:    { label: 'Business tax return / Financial documents', sectionId: 'docSection_homeTies', spFolder: 'Annexture 16 - Travel History', multi: true },
    ...
    adv_home_memberships:     { label: 'Active memberships in societies, charities, service clubs', sectionId: 'docSection_homeTies', spFolder: 'Annexture 16 - Travel History', multi: true },
    adv_home_pets:            { label: 'Pets (pictures / other proofs)', sectionId: 'docSection_homeTies', spFolder: 'Annexture 16 - Travel History', multi: true },
    adv_home_other_financial: { label: 'Other financial evidence', sectionId: 'docSection_homeTies', spFolder: 'Annexture 16 - Travel History', multi: true },
    adv_home_religious_letter:{ label: 'Letter from a religious leader about social services', sectionId: 'docSection_homeTies', spFolder: 'Annexture 16 - Travel History', multi: true },
    adv_home_friend_letters:  { label: 'Two letters from close friends with their IDs/Passports', sectionId: 'docSection_homeTies', spFolder: 'Annexture 16 - Travel History', multi: true },
    adv_home_career_outcome:  { label: 'Post study career outcome proofs', sectionId: 'docSection_homeTies', spFolder: 'Annexture 16 - Travel History', multi: true },
    adv_home_gold_valuation:  { label: 'Valuation reports of gold', sectionId: 'docSection_homeTies', spFolder: 'Annexture 16 - Travel History', multi: true },
    ...
    adv_pf_m_epf_history:    { label: 'EPF — Contribution History report (Myself)', sectionId: 'docSection_fundsMyself', spFolder: 'Annexture 4A - Evidence of Funds - Employee\'s Provident Fund (Myself)', multi: true },
    adv_pf_m_etf_stmt:       { label: 'ETF — Member Account Statement (Myself)', sectionId: 'docSection_fundsMyself', spFolder: 'Annexture 4A - Evidence of Funds - Employee\'s Provident Fund (Myself)', multi: true },
    adv_pf_m_etf_history:    { label: 'ETF — Contribution History report (Myself)', sectionId: 'docSection_fundsMyself', spFolder: 'Annexture 4A - Evidence of Funds - Employee\'s Provident Fund (Myself)', multi: true },
    adv_pf_m_available_proof:{ label: 'Document to prove readily available — PF (Myself)', sectionId: 'docSection_fundsMyself', spFolder: 'Annexture 4A - Evidence of Funds - Employee\'s Provident Fund (Myself)', multi: true },

    // ── Provident Fund Sponsor (Annexture 4B) ──
    adv_pf_s_epf_stmt:       { label: 'EPF — Member Account Statement (Sponsor)', sectionId: 'docSection_fundsSponsor', spFolder: 'Annexture 4B - Evidence of Funds - Employee\'s Provident Fund (Sponsor)', multi: true, subHeading: 'Provident Fund (EPF/ETF)' },
    adv_pf_s_epf_history:    { label: 'EPF — Contribution History report (Sponsor)', sectionId: 'docSection_fundsSponsor', spFolder: 'Annexture 4B - Evidence of Funds - Employee\'s Provident Fund (Sponsor)', multi: true },
    adv_pf_s_etf_stmt:       { label: 'ETF — Member Account Statement (Sponsor)', sectionId: 'docSection_fundsSponsor', spFolder: 'Annexture 4B - Evidence of Funds - Employee\'s Provident Fund (Sponsor)', multi: true },
    adv_pf_s_etf_history:    { label: 'ETF — Contribution History report (Sponsor)', sectionId: 'docSection_fundsSponsor', spFolder: 'Annexture 4B - Evidence of Funds - Employee\'s Provident Fund (Sponsor)', multi: true },
    adv_pf_s_available_proof:{ label: 'Document to prove readily available — PF (Sponsor)', sectionId: 'docSection_fundsSponsor', spFolder: 'Annexture 4B - Evidence of Funds - Employee\'s Provident Fund (Sponsor)', multi: true },
    ...
    adv_loan_repay_security:  { label: 'Security for loans (fixed assets)', sectionId: 'docSection_loanRepayment', spFolder: 'Annexture 11 - Education Loan Repayment Plan', multi: true },
    ...
    adv_sof_emp_m_employer_letter: { label: 'Employer letter / contract with salary confirmation (Myself)', sectionId: 'docSection_sourceMyself', spFolder: 'Annexture 6A - Source of Funds - Savings from Employment (Myself)', multi: true, subHeading: 'Savings from Employment' },
    adv_sof_emp_m_bank_stmt:       { label: 'Bank statement of salary account 3 months (Myself)', sectionId: 'docSection_sourceMyself', spFolder: 'Annexture 6A - Source of Funds - Savings from Employment (Myself)', multi: true },
    adv_sof_emp_m_salary_slips:    { label: 'Salary Slips 3 months (Myself)', sectionId: 'docSection_sourceMyself', spFolder: 'Annexture 6A - Source of Funds - Savings from Employment (Myself)', multi: true },
    adv_sof_emp_m_tax_cert:        { label: 'Income Tax (PAYE) certificate (Myself)', sectionId: 'docSection_sourceMyself', spFolder: 'Annexture 6A - Source of Funds - Savings from Employment (Myself)', multi: true },
    adv_sof_emp_m_bonus:           { label: 'Bonus / commissions proofs (Myself)', sectionId: 'docSection_sourceMyself', spFolder: 'Annexture 6A - Source of Funds - Savings from Employment (Myself)', multi: true },
    adv_sof_emp_m_financial_stmt:  { label: 'Financial Statement from chartered accountant 2 years (Myself)', sectionId: 'docSection_sourceMyself', spFolder: 'Annexture 6A - Source of Funds - Savings from Employment (Myself)', multi: true },
    ...
    adv_sof_emp_s_employer_letter: { label: 'Employer letter / contract with salary confirmation (Sponsor)', sectionId: 'docSection_sourceSponsor', spFolder: 'Annexture 6B - Source of Funds - Savings from Employment (Sponsor)', multi: true, subHeading: 'Savings from Employment' },
    adv_sof_emp_s_bank_stmt:       { label: 'Bank statement of salary account 3 months (Sponsor)', sectionId: 'docSection_sourceSponsor', spFolder: 'Annexture 6B - Source of Funds - Savings from Employment (Sponsor)', multi: true },
    adv_sof_emp_s_salary_slips:    { label: 'Salary Slips 3 months (Sponsor)', sectionId: 'docSection_sourceSponsor', spFolder: 'Annexture 6B - Source of Funds - Savings from Employment (Sponsor)', multi: true },
    adv_sof_emp_s_tax_cert:        { label: 'Income Tax (PAYE) certificate (Sponsor)', sectionId: 'docSection_sourceSponsor', spFolder: 'Annexture 6B - Source of Funds - Savings from Employment (Sponsor)', multi: true },
    adv_sof_emp_s_bonus:           { label: 'Bonus / commissions proofs (Sponsor)', sectionId: 'docSection_sourceSponsor', spFolder: 'Annexture 6B - Source of Funds - Savings from Employment (Sponsor)', multi: true },
    adv_sof_emp_s_financial_stmt:  { label: 'Financial Statement from chartered accountant 2 years (Sponsor)', sectionId: 'docSection_sourceSponsor', spFolder: 'Annexture 6B - Source of Funds - Savings from Employment (Sponsor)', multi: true },
    ...
    adv_sof_biz_m_registration:  { label: 'Business registration (Myself)', sectionId: 'docSection_sourceMyself', spFolder: 'Annexture 7A - Source of Funds - Business (Myself)', multi: true, subHeading: 'Self-employment / Business' },
    adv_sof_biz_m_pnl:           { label: 'Profit and loss statements by chartered accountant (Myself)', sectionId: 'docSection_sourceMyself', spFolder: 'Annexture 7A - Source of Funds - Business (Myself)', multi: true },
    adv_sof_biz_m_tax:           { label: 'Business TAX evidence (Myself)', sectionId: 'docSection_sourceMyself', spFolder: 'Annexture 7A - Source of Funds - Business (Myself)', multi: true },
    ...
    adv_sof_biz_m_bank_stmt:     { label: 'Bank accounts statements 6 months (Myself)', sectionId: 'docSection_sourceMyself', spFolder: 'Annexture 7A - Source of Funds - Business (Myself)', multi: true },

    // ── Source: Business Sponsor (Annexture 7B) ──
    adv_sof_biz_s_registration:  { label: 'Business registration (Sponsor)', sectionId: 'docSection_sourceSponsor', spFolder: 'Annexture 7B - Source of Funds - Business (Sponsor)', multi: true, subHeading: 'Self-employment / Business' },
    adv_sof_biz_s_pnl:           { label: 'Profit and loss statements by chartered accountant (Sponsor)', sectionId: 'docSection_sourceSponsor', spFolder: 'Annexture 7B - Source of Funds - Business (Sponsor)', multi: true },
    adv_sof_biz_s_tax:           { label: 'Business TAX evidence (Sponsor)', sectionId: 'docSection_sourceSponsor', spFolder: 'Annexture 7B - Source of Funds - Business (Sponsor)', multi: true },
    ...
    adv_sof_biz_s_bank_stmt:     { label: 'Bank accounts statements 6 months (Sponsor)', sectionId: 'docSection_sourceSponsor', spFolder: 'Annexture 7B - Source of Funds - Business (Sponsor)', multi: true },

    // ── Source: Rental Myself (Annexture 8A) ──
    adv_sof_rent_m_lease:            { label: 'Lease agreement (Myself)', sectionId: 'docSection_sourceMyself', spFolder: 'Annexture 8A - Source of Funds - Rental Property (Myself)', multi: true, subHeading: 'Rent / Lease Income' },
    adv_sof_rent_m_deed:             { label: 'Deed of the property (Myself)', sectionId: 'docSection_sourceMyself', spFolder: 'Annexture 8A - Source of Funds - Rental Property (Myself)', multi: true },
    adv_sof_rent_m_valuation:        { label: 'Valuation of the Property (Myself)', sectionId: 'docSection_sourceMyself', spFolder: 'Annexture 8A - Source of Funds - Rental Property (Myself)', multi: true },
    adv_sof_rent_m_bank_stmt:        { label: 'Bank statement showing receipt of funds (Myself)', sectionId: 'docSection_sourceMyself', spFolder: 'Annexture 8A - Source of Funds - Rental Property (Myself)', multi: true },
    adv_sof_rent_m_accountant_letter:{ label: 'Signed letter from chartered accountant — Rental (Myself)', sectionId: 'docSection_sourceMyself', spFolder: 'Annexture 8A - Source of Funds - Rental Property (Myself)', multi: true },
    adv_sof_rent_m_invoices:         { label: 'Rental Invoices (Myself)', sectionId: 'docSection_sourceMyself', spFolder: 'Annexture 8A - Source of Funds - Rental Property (Myself)', multi: true },

    // ── Source: Rental Sponsor (Annexture 8B) ──
    adv_sof_rent_s_lease:            { label: 'Lease agreement (Sponsor)', sectionId: 'docSection_sourceSponsor', spFolder: 'Annexture 8B - Source of Funds - Rental Property (Sponsor)', multi: true, subHeading: 'Rent / Lease Income' },
    adv_sof_rent_s_deed:             { label: 'Deed of the property (Sponsor)', sectionId: 'docSection_sourceSponsor', spFolder: 'Annexture 8B - Source of Funds - Rental Property (Sponsor)', multi: true },
    adv_sof_rent_s_valuation:        { label: 'Valuation of the Property (Sponsor)', sectionId: 'docSection_sourceSponsor', spFolder: 'Annexture 8B - Source of Funds - Rental Property (Sponsor)', multi: true },
    adv_sof_rent_s_bank_stmt:        { label: 'Bank statement showing receipt of funds (Sponsor)', sectionId: 'docSection_sourceSponsor', spFolder: 'Annexture 8B - Source of Funds - Rental Property (Sponsor)', multi: true },
    adv_sof_rent_s_accountant_letter:{ label: 'Signed letter from chartered accountant — Rental (Sponsor)', sectionId: 'docSection_sourceSponsor', spFolder: 'Annexture 8B - Source of Funds - Rental Property (Sponsor)', multi: true },
    adv_sof_rent_s_invoices:         { label: 'Rental Invoices (Sponsor)', sectionId: 'docSection_sourceSponsor', spFolder: 'Annexture 8B - Source of Funds - Rental Property (Sponsor)', multi: true },
    ...
    adv_sof_epf_m_salary_slips:     { label: 'Last 6 months salary slips — EPF Link (Myself)', sectionId: 'docSection_sourceMyself', spFolder: 'Annexture 9A - Source of Funds - Employment link to EPF (Myself)', multi: true },
    ...
    adv_sof_epf_m_epf_balance:      { label: 'EPF/ETF — Balance confirmation (Myself)', sectionId: 'docSection_sourceMyself', spFolder: 'Annexture 9A - Source of Funds - Employment link to EPF (Myself)', multi: true },
    adv_sof_epf_m_epf_contrib:      { label: 'EPF/ETF — Contribution History report (Myself)', sectionId: 'docSection_sourceMyself', spFolder: 'Annexture 9A - Source of Funds - Employment link to EPF (Myself)', multi: true },
    adv_sof_epf_m_receival_proof:   { label: 'Docs to prove receival of EPF/ETF (Myself)', sectionId: 'docSection_sourceMyself', spFolder: 'Annexture 9A - Source of Funds - Employment link to EPF (Myself)', multi: true },
    ...
    adv_sof_epf_s_salary_slips:     { label: 'Last 6 months salary slips — EPF Link (Sponsor)', sectionId: 'docSection_sourceSponsor', spFolder: 'Annexture 9B - Source of Funds - Employment link to EPF (Sponsor)', multi: true },
    ...
    adv_sof_epf_s_epf_balance:      { label: 'EPF/ETF — Balance confirmation (Sponsor)', sectionId: 'docSection_sourceSponsor', spFolder: 'Annexture 9B - Source of Funds - Employment link to EPF (Sponsor)', multi: true },
    adv_sof_epf_s_epf_contrib:      { label: 'EPF/ETF — Contribution History report (Sponsor)', sectionId: 'docSection_sourceSponsor', spFolder: 'Annexture 9B - Source of Funds - Employment link to EPF (Sponsor)', multi: true },
    adv_sof_epf_s_receival_proof:   { label: 'Docs to prove receival of EPF/ETF (Sponsor)', sectionId: 'docSection_sourceSponsor', spFolder: 'Annexture 9B - Source of Funds - Employment link to EPF (Sponsor)', multi: true },

    // ── Source: Other Myself (Annexture 10A) — all sub-items ──
    adv_sof_oth_m_prop_deed_orig:  { label: 'Sale of Property — Transfer deeds original (Myself)', sectionId: 'docSection_sourceMyself', spFolder: 'Annexture 10A - Source of Funds - Other (Myself)', multi: true, subHeading: 'Other Sources' },
    adv_sof_oth_m_prop_deed_trans: { label: 'Sale of Property — Transfer deeds (Translation) (Myself)', sectionId: 'docSection_sourceMyself', spFolder: 'Annexture 10A - Source of Funds - Other (Myself)', multi: true },
    adv_sof_oth_m_prop_sale_agree: { label: 'Sale of Property — Sales agreement (Myself)', sectionId: 'docSection_sourceMyself', spFolder: 'Annexture 10A - Source of Funds - Other (Myself)', multi: true },
    adv_sof_oth_m_prop_valuation:  { label: 'Sale of Property — Land Valuation Report (Myself)', sectionId: 'docSection_sourceMyself', spFolder: 'Annexture 10A - Source of Funds - Other (Myself)', multi: true },
    adv_sof_oth_m_prop_bank_stmt:  { label: 'Sale of Property — Bank statement showing receipt (Myself)', sectionId: 'docSection_sourceMyself', spFolder: 'Annexture 10A - Source of Funds - Other (Myself)', multi: true },
    adv_sof_oth_m_veh_book:        { label: 'Sale of Vehicle — Vehicle book / Transfer agreement (Myself)', sectionId: 'docSection_sourceMyself', spFolder: 'Annexture 10A - Source of Funds - Other (Myself)', multi: true },
    adv_sof_oth_m_veh_valuation:   { label: 'Sale of Vehicle — Valuation Report (Myself)', sectionId: 'docSection_sourceMyself', spFolder: 'Annexture 10A - Source of Funds - Other (Myself)', multi: true },
    adv_sof_oth_m_veh_sale_agree:  { label: 'Sale of Vehicle — Sales agreement (Myself)', sectionId: 'docSection_sourceMyself', spFolder: 'Annexture 10A - Source of Funds - Other (Myself)', multi: true },
    adv_sof_oth_m_veh_bank_stmt:   { label: 'Sale of Vehicle — Bank statement showing receipt (Myself)', sectionId: 'docSection_sourceMyself', spFolder: 'Annexture 10A - Source of Funds - Other (Myself)', multi: true },
    adv_sof_oth_m_gold_purchase:   { label: 'Sale of Gold — Purchase Invoice (Myself)', sectionId: 'docSection_sourceMyself', spFolder: 'Annexture 10A - Source of Funds - Other (Myself)', multi: true },
    adv_sof_oth_m_gold_sale:       { label: 'Sale of Gold — Sale Invoice (Myself)', sectionId: 'docSection_sourceMyself', spFolder: 'Annexture 10A - Source of Funds - Other (Myself)', multi: true },
    adv_sof_oth_m_gold_valuation:  { label: 'Sale of Gold — Valuation Report (Myself)', sectionId: 'docSection_sourceMyself', spFolder: 'Annexture 10A - Source of Funds - Other (Myself)', multi: true },
    adv_sof_oth_m_gold_bank_stmt:  { label: 'Sale of Gold — Bank statement showing receipt (Myself)', sectionId: 'docSection_sourceMyself', spFolder: 'Annexture 10A - Source of Funds - Other (Myself)', multi: true },
    adv_sof_oth_m_inherit_probate: { label: 'Inheritance — Grant of Probate (will) (Myself)', sectionId: 'docSection_sourceMyself', spFolder: 'Annexture 10A - Source of Funds - Other (Myself)', multi: true },
    adv_sof_oth_m_inherit_valuation:{ label: 'Inheritance — Valuation report (Myself)', sectionId: 'docSection_sourceMyself', spFolder: 'Annexture 10A - Source of Funds - Other (Myself)', multi: true },
    ...
    adv_sof_oth_s_prop_deed_orig:  { label: 'Sale of Property — Transfer deeds original (Sponsor)', sectionId: 'docSection_sourceSponsor', spFolder: 'Annexture 10B - Source of Funds - Other (Sponsor)', multi: true, subHeading: 'Other Sources' },
    adv_sof_oth_s_prop_deed_trans: { label: 'Sale of Property — Transfer deeds (Translation) (Sponsor)', sectionId: 'docSection_sourceSponsor', spFolder: 'Annexture 10B - Source of Funds - Other (Sponsor)', multi: true },
    adv_sof_oth_s_prop_sale_agree: { label: 'Sale of Property — Sales agreement (Sponsor)', sectionId: 'docSection_sourceSponsor', spFolder: 'Annexture 10B - Source of Funds - Other (Sponsor)', multi: true },
    adv_sof_oth_s_prop_valuation:  { label: 'Sale of Property — Land Valuation Report (Sponsor)', sectionId: 'docSection_sourceSponsor', spFolder: 'Annexture 10B - Source of Funds - Other (Sponsor)', multi: true },
    adv_sof_oth_s_prop_bank_stmt:  { label: 'Sale of Property — Bank statement showing receipt (Sponsor)', sectionId: 'docSection_sourceSponsor', spFolder: 'Annexture 10B - Source of Funds - Other (Sponsor)', multi: true },
    adv_sof_oth_s_veh_book:        { label: 'Sale of Vehicle — Vehicle book / Transfer agreement (Sponsor)', sectionId: 'docSection_sourceSponsor', spFolder: 'Annexture 10B - Source of Funds - Other (Sponsor)', multi: true },
    adv_sof_oth_s_veh_valuation:   { label: 'Sale of Vehicle — Valuation Report (Sponsor)', sectionId: 'docSection_sourceSponsor', spFolder: 'Annexture 10B - Source of Funds - Other (Sponsor)', multi: true },
    adv_sof_oth_s_veh_sale_agree:  { label: 'Sale of Vehicle — Sales agreement (Sponsor)', sectionId: 'docSection_sourceSponsor', spFolder: 'Annexture 10B - Source of Funds - Other (Sponsor)', multi: true },
    adv_sof_oth_s_veh_bank_stmt:   { label: 'Sale of Vehicle — Bank statement showing receipt (Sponsor)', sectionId: 'docSection_sourceSponsor', spFolder: 'Annexture 10B - Source of Funds - Other (Sponsor)', multi: true },
    adv_sof_oth_s_gold_purchase:   { label: 'Sale of Gold — Purchase Invoice (Sponsor)', sectionId: 'docSection_sourceSponsor', spFolder: 'Annexture 10B - Source of Funds - Other (Sponsor)', multi: true },
    adv_sof_oth_s_gold_sale:       { label: 'Sale of Gold — Sale Invoice (Sponsor)', sectionId: 'docSection_sourceSponsor', spFolder: 'Annexture 10B - Source of Funds - Other (Sponsor)', multi: true },
    adv_sof_oth_s_gold_valuation:  { label: 'Sale of Gold — Valuation Report (Sponsor)', sectionId: 'docSection_sourceSponsor', spFolder: 'Annexture 10B - Source of Funds - Other (Sponsor)', multi: true },
    adv_sof_oth_s_gold_bank_stmt:  { label: 'Sale of Gold — Bank statement showing receipt (Sponsor)', sectionId: 'docSection_sourceSponsor', spFolder: 'Annexture 10B - Source of Funds - Other (Sponsor)', multi: true },
    adv_sof_oth_s_inherit_probate: { label: 'Inheritance — Grant of Probate (will) (Sponsor)', sectionId: 'docSection_sourceSponsor', spFolder: 'Annexture 10B - Source of Funds - Other (Sponsor)', multi: true },
    adv_sof_oth_s_inherit_valuation:{ label: 'Inheritance — Valuation report (Sponsor)', sectionId: 'docSection_sourceSponsor', spFolder: 'Annexture 10B - Source of Funds - Other (Sponsor)', multi: true },
